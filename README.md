...
<img src="guillaume_bellec_lac.jpg" alt="Photo" width="200px" />
  ...
  I develop computational theories of brains and intelligent machines which are regularly published in selective computer science conference like NeurIPS or ICLR and scientific journals like Nature Communications. I studied machine learning during my Master in Paris and I completed my PhD in the Institute for Theoretical Computer Science of TU Graz in Austria. Currently, I am now a postdoc in the Laboratory of Computational Neuroscience at EPFL in Switzerland. My work is most well-known for showing that a powerful intelligence can emerge from simple mathematical models of biologically realistic neural networks.
